...
export function EditarCliente() {
    ...
    useEffect(() => {
        axios.get(`http://localhost:3001/clientes?id=${id}`)
        .then((response) => {
    ...
    return (
        <div className="container">
            <div style={{ display: "flex", justifyContent: "flex-end" }}>
                    <h1 style={{ color: "#021B79", marginTop: "0.3em" }}>Edição de cliente</h1>
            </div>
            <hr />
            <Form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Form.Group className="mb-3">
                    ...
                    <Form.Control type="text" className={errors.endereco && "is-invalid"} {...register("endereco", { required: "O endereço é obrigatório.", maxLength: { value: 130, message: "Limite de 20 caracteres." } })} />

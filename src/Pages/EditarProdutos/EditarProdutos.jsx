...
export function EditarProduto() {
    ...
    useEffect(() => {
        ...
        .then((response) => {
            const { nome, origem, valor_venda, valor_frete, valor_desconto, valor_total } = response.data;
            reset({ nome, origem, valor_venda, valor_frete, valor_desconto, valor_total });
        })
    }, [id, reset]);
    ...
    return (
        <div className="container">
            <div style={{ display: "flex", justifyContent: "flex-end" }}>
                    <h1 style={{ color: "#021B79", marginTop: "0.3em" }}>Edição de produtos</h1>
            </div>
            <hr />
            <Form onSubmit={handleSubmit(onSubmit)}>
                <Form.Group className="mb-3">
                    ...
                    {...register("nome", { required: "O nome é obrigatório.", maxLength: { value: 130, message: "Limite de 20 caracteres." } })}/>
